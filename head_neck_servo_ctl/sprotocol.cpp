...
//				msg->pan_neck_pos, msg->tilt_neck_pos);
		...
		pt_ctrl.pan_left_angle = msg->pan_left_pos;
		pt_ctrl.tilt_left_angle = msg->tilt_left_pos;
		pt_ctrl.pan_right_angle = msg->pan_right_pos;
		pt_ctrl.tilt_right_angle = msg->tilt_right_pos;
		pt_ctrl.pan_neck_angle = msg->pan_neck_pos;
		pt_ctrl.tilt_neck_angle = msg->tilt_neck_pos;
